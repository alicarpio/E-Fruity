...
<template>
  <nav
    class="flex px-5 py-1 text-gray-700 border border-gray-200 rounded-lg w-2/3 bg-[#EDF0F8]"
  ...
  >
    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
      <li class="inline-flex items-center">
        <a
          href="#"
          class="inline-flex items-center text-sm font-medium text-[#A3A9C2] hover:text-blue-600"
        >
          <svg
